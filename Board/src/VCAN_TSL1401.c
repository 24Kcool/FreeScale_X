...
#if 1             //宏条件编译选择不同的信号类型
ADCn_Ch_e   tsl1401_ch[] = {ADC1_SE16,     ADC0_SE16,    ADC1_DP1};       //CCD所用的 ADC通道(原始信号)
#else
ADCn_Ch_e   tsl1401_ch[] = {ADC1_DM1,     ADC0_DM1,    ADC1_DM1};       //CCD所用的 ADC通道(放大信号)
#endif
PTXn_e      tsl1401_si[] = {PTE5 ,        PTE3 ,       PTE10};          //CCD所用的 SI管脚
PTXn_e      tsl1401_clk[] = {PTE4 ,        PTE2 ,       PTE12};         //CCD所用的 SI管脚
